...
public class prereqs1 {
    ...
    private DcMotor frontRight, frontLeft, backRight, backLeft, turret;
    // Class members
    ...
    public void init(HardwareMap hwMap) {
        ...
        myOtos.setSignalProcessConfig(new SparkFunOTOS.SignalProcessConfig((byte) 0x0D));// disables accelerometer
        myOtos.setOffset(new SparkFunOTOS.Pose2D(-7.304, -1.636, 0));
